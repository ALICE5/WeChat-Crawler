...
function select_time1()
{
    ...
    p.innerHTML="2018年9月13日 "+" 至 "+" 2018年9月13日";
    $("#box_chart1").show();
	$("#box_chart2").hide();
	$("#box_chart3").hide();
	$("#box_chart4").hide();
...
function select_time2()
{
    var p = document.getElementById("showtime");
    p.innerHTML="2018年9月7日 "+" 至 "+" 2018年9月13日";
    $("#box_chart1").hide();
	$("#box_chart2").show();
	$("#box_chart3").hide();
	$("#box_chart4").hide();
...
function select_time3()
{
    var p = document.getElementById("showtime");
    p.innerHTML="2018年8月30日 "+" 至 "+" 2018年9月13日";
    $("#box_chart1").hide();
	$("#box_chart2").hide();
	$("#box_chart3").show();
	$("#box_chart4").hide();
...
function select_time4()
{
    var p = document.getElementById("showtime");
    p.innerHTML="2018年8月14日 "+" 至 "+" 2018年9月13日";
    $("#box_chart1").hide();
	$("#box_chart2").hide();
	$("#box_chart3").hide();
	$("#box_chart4").show();
