...
def Page3_1(request):
    ...
    original_day_one = {
        ...
        "mean_readNum": int(count_original_readNum_list["count_original_one_readNum"]/int(count_original_paper_list["count_original_one_paper"])),
        "mean_likeNum": "%.2f" % (int(count_original_likeNum_list["count_original_one_likeNum"]) / int(
            count_original_paper_list["count_original_one_paper"]))
    }
    original_day_two = {
        "date": "2018-8-31",
        ...
        "mean_readNum": int(count_original_readNum_list["count_original_two_readNum"]/int(count_original_paper_list["count_original_two_paper"])),
        "mean_likeNum": "%.2f" % (int(count_original_likeNum_list["count_original_two_likeNum"]) / int(
            count_original_paper_list["count_original_two_paper"]))
    }
    original_day_three = {
        "date": "2018-9-1",
        ...
        "mean_readNum": int(count_original_readNum_list["count_original_three_readNum"]/int(count_original_paper_list["count_original_three_paper"])),
        "mean_likeNum": "%.2f" % (int(count_original_likeNum_list["count_original_three_likeNum"]) / int(
            count_original_paper_list["count_original_three_paper"]))
    }
    original_day_four = {
        "date": "2018-9-2",
        ...
        "mean_readNum": int(count_original_readNum_list["count_original_four_readNum"]/int(count_original_paper_list["count_original_four_paper"])),
        "mean_likeNum": "%.2f" % (int(count_original_likeNum_list["count_original_four_likeNum"]) / int(
            count_original_paper_list["count_original_four_paper"]))
    }
    original_day_five = {
        "date": "2018-9-3",
        ...
        "mean_readNum": int(count_original_readNum_list["count_original_five_readNum"]/int(count_original_paper_list["count_original_five_paper"])),
        "mean_likeNum": "%.2f" % (int(count_original_likeNum_list["count_original_five_likeNum"]) / int(
            count_original_paper_list["count_original_five_paper"]))
    }
    original_day_six = {
        "date": "2018-9-4",
        ...
        "mean_readNum": int(count_original_readNum_list["count_original_six_readNum"]/int(count_original_paper_list["count_original_six_paper"])),
        "mean_likeNum": "%.2f" % (int(count_original_likeNum_list["count_original_six_likeNum"]) / int(
            count_original_paper_list["count_original_six_paper"]))
    }
    original_day_seven = {
        "date": "2018-9-5",
        ...
        "mean_readNum": int(count_original_readNum_list["count_original_seven_readNum"]/int(count_original_paper_list["count_original_seven_paper"])),
        "mean_likeNum": "%.2f" % (int(count_original_likeNum_list["count_original_seven_likeNum"]) / int(
            count_original_paper_list["count_original_seven_paper"]))
    }
    ...
    reprint_day_one = {
        ...
        "mean_readNum": int(count_reprint_readNum_list["count_reprint_one_readNum"]/int(count_reprint_paper_list["count_reprint_one_paper"])),
        "mean_likeNum": "%.2f" % (int(count_reprint_likeNum_list["count_reprint_one_likeNum"]) / int(
            count_reprint_paper_list["count_reprint_one_paper"]))
    }
    reprint_day_two = {
        "date": "2018-8-31",
        ...
        "mean_readNum": int(count_reprint_readNum_list["count_reprint_two_readNum"]/int(count_reprint_paper_list["count_reprint_two_paper"])),
        "mean_likeNum": "%.2f" % (int(count_reprint_likeNum_list["count_reprint_two_likeNum"]) / int(
            count_reprint_paper_list["count_reprint_two_paper"]))
    }
    reprint_day_three = {
        "date": "2018-9-1",
        ...
        "mean_readNum": int(count_reprint_readNum_list["count_reprint_three_readNum"]/int(count_reprint_paper_list["count_reprint_three_paper"])),
        "mean_likeNum": "%.2f" % (int(count_reprint_likeNum_list["count_reprint_three_likeNum"]) / int(
            count_reprint_paper_list["count_reprint_three_paper"]))
    }
    reprint_day_four = {
        "date": "2018-9-2",
        ...
        "mean_readNum": int(count_reprint_readNum_list["count_reprint_four_readNum"]/int(count_reprint_paper_list["count_reprint_four_paper"])),
        "mean_likeNum": "%.2f" %(int(count_reprint_likeNum_list["count_reprint_four_likeNum"]) / int(
            count_reprint_paper_list["count_reprint_four_paper"]))
    }
    reprint_day_five = {
        "date": "2018-9-3",
        ...
        "mean_readNum": int(count_reprint_readNum_list["count_reprint_five_readNum"]/int(count_reprint_paper_list["count_reprint_five_paper"])),
        "mean_likeNum": "%.2f" %(int(count_reprint_likeNum_list["count_reprint_five_likeNum"]) / int(
            count_reprint_paper_list["count_reprint_five_paper"]))
    }
    reprint_day_six = {
        "date": "2018-9-4",
        ...
        "mean_readNum": int(count_reprint_readNum_list["count_reprint_six_readNum"]/int(count_reprint_paper_list["count_reprint_six_paper"])),
        "mean_likeNum": "%.2f" %(int(count_reprint_likeNum_list["count_reprint_six_likeNum"]) / int(
            count_reprint_paper_list["count_reprint_six_paper"]))
    }
    reprint_day_seven = {
        "date": "2018-9-5",
        ...
        "mean_readNum": int(count_reprint_readNum_list["count_reprint_seven_readNum"]/int(count_reprint_paper_list["count_reprint_seven_paper"])),
        "mean_likeNum": "%.2f" %(int(count_reprint_likeNum_list["count_reprint_seven_likeNum"]) / int(
            count_reprint_paper_list["count_reprint_seven_paper"]))
    }
